...
class AddressRepositoryImpl implements AdressRepository {
  @override
  Future<Address> getEndereco(String cep) async {
    var url = Uri.parse('https://viacep.com.br/ws/$cep/json/');
  var response = await http.get(url);
  return Future.delayed(Duration(milliseconds: 800)).then((v) => Address.fromJson(jsonDecode(response.body)));
  }
