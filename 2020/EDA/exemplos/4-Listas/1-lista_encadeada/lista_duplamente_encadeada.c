...
// Inicializando uma lista duplamente encadeada juntamente com seus membros
...
{
    return dlist_size(l) == 0 ?: 0;
}

// Criando um novo nó
// (Como diferença da lista encadeada normal, aqui definimos o ponteiro para o elemento anterior como NULL)
...
// Inserindo um elemento numa posição dada da lista
...
// Removendo um elemento na cabeça da lista
...
// Removendo um elemento na cauda da lista
...
// Removendo o elemento da posição i da dlista
...
// Acessando um elemento que está na cabeça da lista
...
// Acessando um elemento que está na cauda da lista
...
// Deletando a lista por inteiro e libera espaço em memória
