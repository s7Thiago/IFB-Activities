...
//                     Building content to transfer
                    ...
                    strcat(tagContents[contentsCount], auxCharContentTag);
                    printf("\t\t\tContent: %s\n", tagContents[0]);
                    //printf("%s", auxCharContentTag);
                    
//                  Limpando a matriz
                    //cleanStringMatrix(tagContents, 50);
